...
- [1. 版本管理基础](#1-版本管理基础)
  - [1.1 目的与适用范围](#11-目的与适用范围)
  - [1.2 统一版本来源](#12-统一版本来源)
  - [1.3 版本号格式与升级规则](#13-版本号格式与升级规则)
- [2. 版本变更与记录](#2-版本变更与记录)
  - [2.1 版本号更新时间](#21-版本号更新时间)
  - [2.2 版本修改内容与提交要求](#22-版本修改内容与提交要求)
  - [2.3 CHANGELOG 规范](#23-changelog-规范)
- [3. 发布、制品与校验](#3-发布制品与校验)
  - [3.1 候选制品、Tag 与正式发布](#31-候选制品tag-与正式发布)
  - [3.2 运行时版本信息](#32-运行时版本信息)
  - [3.3 CI 强制校验](#33-ci-强制校验)
  - [3.4 分支与版本关系](#34-分支与版本关系)
- [4. 职责与管控](#4-职责与管控)
  - [4.1 角色与责任](#41-角色与责任)
  - [4.2 禁止事项](#42-禁止事项)
- [5. 发布检查清单](#5-发布检查清单)
