...
| [GitLab 开发与发布流程规范](./GITLAB_DEVELOPMENT_WORKFLOW.md) | 规定项目首次交付、持续迭代、分支管理、代码合并、版本发布和紧急修复流程。 |
...
2. 项目负责人阅读 [GitLab 项目配置与开发管理规范](./GITLAB_PROJECT_MANAGEMENT.md)，完成项目及权限配置。
3. 开始项目交付或日常开发前阅读 [GitLab 开发与发布流程规范](./GITLAB_DEVELOPMENT_WORKFLOW.md) 和 [GitLab Merge Request 代码审查规范](./GITLAB_CODE_REVIEW.md)。
