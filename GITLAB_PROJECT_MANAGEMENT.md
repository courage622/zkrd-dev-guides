...
- [1. 项目规划与创建](#1-项目规划与创建)
  - [1.1 适用范围](#11-适用范围)
  - [1.2 在已有 Group 下创建项目](#12-在已有-group-下创建项目)
- [2. 代码库与权限配置](#2-代码库与权限配置)
  - [2.1 初始化代码库](#21-初始化代码库)
  - [2.2 配置成员和权限](#22-配置成员和权限)
  - [2.3 配置分支和 Tag 保护](#23-配置分支和-tag-保护)
- [3. 项目开发工作流程](#3-项目开发工作流程)
  - [3.1 所有开发必须有明确任务](#31-所有开发必须有明确任务)
  - [3.2 从 `dev` 创建任务分支](#32-从-dev-创建任务分支)
  - [3.3 开发和提交](#33-开发和提交)
  - [3.4 创建 MR](#34-创建-mr)
  - [3.5 评审和合并](#35-评审和合并)
- [4. 过程管控与版本发布](#4-过程管控与版本发布)
  - [4.1 开发过程管控](#41-开发过程管控)
  - [4.2 版本发布](#42-版本发布)
- [5. 检查清单与管控原则](#5-检查清单与管控原则)
  - [5.1 开发经理初始化检查清单](#51-开发经理初始化检查清单)
  - [5.2 核心管控原则](#52-核心管控原则)
